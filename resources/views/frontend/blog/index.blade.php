...
@section('content')
<!-- BLOG HERO -->
<section style="background:linear-gradient(135deg,rgba(var(--theme-primary-rgb,245,158,11),0.12),rgba(var(--theme-secondary-rgb,244,63,94),0.08));padding-top:140px;padding-bottom:4rem;position:relative;overflow:hidden;">
