...
<body>
    ...
    <script>
        ...
        // Automatically open Ecommerce submenu if on category, product, tags, reviews, or orders pages
        document.addEventListener('DOMContentLoaded', function() {
            const currentPath = window.location.pathname;
            if (currentPath.includes('/admin/ecommerce/categories') || currentPath.includes('/admin/ecommerce/products') || currentPath.includes('/admin/ecommerce/tags') || currentPath.includes('/admin/ecommerce/reviews') || currentPath.includes('/admin/ecommerce/orders')) {
