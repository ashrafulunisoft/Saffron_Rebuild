...
<div class="container-fluid">
    <div class="glass-card glass-card-dark">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2.5rem; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 1.5rem;">
            ...
            <div class="d-flex align-items-center gap-3">
                <h2 class="fw-800 mb-0 text-white letter-spacing-1 text-shadow-white" style="font-size: 2rem;">Create New Page</h2>
        ...
        <form action="{{ route('admin.ecommerce.cms.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="title_en" class="input-dark input-custom" required placeholder="e.g., About Us" value="{{ old('title_en') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="slug" class="input-dark input-custom" required placeholder="e.g., about-us" value="{{ old('slug') }}" pattern="[a-z0-9-]+" title="Only lowercase letters, numbers, and hyphens">
                    @error('slug') <div class="text-danger">{{ $message }}</div> @enderror
                </div>

                <div class="col-12">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Excerpt / সারাংশ</label>
                    <textarea name="excerpt_en" class="input-dark input-custom" rows="2" placeholder="Short description...">{{ old('excerpt_en') }}</textarea>
                </div>

                <div class="col-12">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Content / বিষয়বস্তু</label>
                    <textarea name="content_en" class="input-dark input-custom" rows="10" placeholder="Full page content...">{{ old('content_en') }}</textarea>
                </div>
            </div>
            ...
            <div class="row g-4 mb-4" style="background: rgba(139, 92, 246, 0.05); padding: 1.5rem; border-radius: 16px; border: 1px solid rgba(139, 92, 246, 0.2);">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="title_bn" class="input-dark input-custom" placeholder="যেমন: আমাদের সম্পর্কে" value="{{ old('title_bn') }}">
                </div>

                <div class="col-12">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">সারাংশ (Excerpt)</label>
                    <textarea name="excerpt_bn" class="input-dark input-custom" rows="2" placeholder="সংক্ষিপ্ত বিবরণ...">{{ old('excerpt_bn') }}</textarea>
                </div>

                <div class="col-12">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">বিষয়বস্তু (Content)</label>
                    <textarea name="content_bn" class="input-dark input-custom" rows="10" placeholder="সম্পূর্ণ পেজ বিষয়বস্তু...">{{ old('content_bn') }}</textarea>
                </div>
            </div>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="meta_title" class="input-dark input-custom" placeholder="SEO title..." value="{{ old('meta_title') }}">
                </div>

                <div class="col-md-6">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Meta Keywords</label>
                    <input type="text" name="meta_keywords" class="input-dark input-custom" placeholder="keyword1, keyword2,..." value="{{ old('meta_keywords') }}">
                </div>

                <div class="col-12">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Meta Description</label>
                    <textarea name="meta_description" class="input-dark input-custom" rows="2" placeholder="SEO description...">{{ old('meta_description') }}</textarea>
                </div>
            </div>
