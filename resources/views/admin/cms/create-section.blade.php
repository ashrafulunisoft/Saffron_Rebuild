...
@section('title', 'Create Section - Admin')
...
<div class="container-fluid">
    <div class="glass-card glass-card-dark">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2.5rem; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 1.5rem;">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <span class="permission-title" style="font-size: 0.7rem; margin: 0; text-shadow-blue">CREATE SECTION - {{ $cms->title }}</span>
                </div>
            </div>
        ...
        <form action="{{ route('admin.ecommerce.cms.sections.store', $cms) }}" method="POST">
            @csrf
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="section_key" class="input-dark input-custom" required placeholder="e.g., hero, who-we-are" pattern="[a-z0-9-]+" title="Only lowercase letters, numbers, and hyphens">
                    @error('section_key') <div class="text-danger">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-4">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Sort Order</label>
                    <input type="number" name="sort_order" class="input-dark input-custom" value="0" min="0">
                </div>

                <div class="col-md-4">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Icon (optional)</label>
                    <input type="text" name="icon" class="input-dark input-custom" placeholder="e.g., fa-star">
                    <small style="color: rgba(255,255,255,0.5);">Font Awesome class without "fa-" prefix</small>
                </div>
            </div>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="title_en" class="input-dark input-custom" required>
                </div>

                <div class="col-md-6">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Subtitle (EN)</label>
                    <input type="text" name="subtitle_en" class="input-dark input-custom">
                </div>

                <div class="col-12">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Content (EN)</label>
                    <textarea name="content_en" class="input-dark input-custom" rows="4"></textarea>
                </div>
            </div>
            ...
            <div class="row g-4 mb-4" style="background: rgba(139, 92, 246, 0.05); padding: 1.5rem; border-radius: 16px; border: 1px solid rgba(139, 92, 246, 0.2);">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="title_bn" class="input-dark input-custom">
                </div>

                <div class="col-md-6">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">সাবটাইটেল (Subtitle)</label>
                    <input type="text" name="subtitle_bn" class="input-dark input-custom">
                </div>

                <div class="col-12">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">বিষয়বস্তু (Content)</label>
                    <textarea name="content_bn" class="input-dark input-custom" rows="4"></textarea>
                </div>
            </div>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="button_text_en" class="input-dark input-custom" placeholder="e.g., Shop Now">
                </div>

                <div class="col-md-4">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Button Text (BN)</label>
                    <input type="text" name="button_text_bn" class="input-dark input-custom" placeholder="যেমন: এখনই কিনুন">
                </div>

                <div class="col-md-4">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Button URL</label>
                    <input type="text" name="button_url" class="input-dark input-custom" placeholder="/shop">
                </div>

                <div class="col-md-12">
                    <label class="form-label" style="color: rgba(255,255,255,0.7);">Image URL</label>
                    <input type="text" name="image_url" class="input-dark input-custom" placeholder="/images/hero-bg.jpg">
                </div>
            </div>
            ...
            <div class="row g-4 mb-4">
                <div class="col-12">
                    <div class="form-check" style="padding: 1rem; background: rgba(34, 197, 94, 0.1); border: 1px solid rgba(34, 197, 94, 0.2); border-radius: 10px;">
                        <input class="form-check-input" type="checkbox" name="is_active" id="isActive" checked style="width: 1.2rem; height: 1.2rem; cursor: pointer;">
